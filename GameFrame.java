 ...
 */
 ...
 public class GameFrame extends JFrame {
     ...
     private void createPlayers() {
         if (playerID == 1) {
             player = new Player(100, 400, 50, Color.BLUE, 1);
             enemyPlayer = new Player(490, 400, 50, Color.RED, 2);
         } else {
             enemyPlayer = new Player(100, 400, 50, Color.BLUE, 1);
             player = new Player(490, 400, 50, Color.RED, 2);
         }
     }
     ...
     private void checkDoorInteractions() {
         ...
         if (player.getY() >= 580 && player.getY() <= 680) {
             boolean isAtLeftDoor = player.getX() >= 455 && player.getX() <= 505;
             boolean isAtRightDoor = player.getX() >= 505 && player.getX() <= 555;
             
             // If player 1 is at left door or player 2 is at right door
             if ((playerID == 1 && isAtLeftDoor) || (playerID == 2 && isAtRightDoor)) {
                 if (interacting) {
         ...
         KeyListener kl = new KeyListener() {
             ...
             public void keyReleased(KeyEvent ke) {
                 ...
                 switch (keyCode) {
                     ...
                     case KeyEvent.VK_SPACE:
                         interacting = false;
                         // Send end interaction message to server
